function varargout = artifactRej(varargin)
% ARTIFACTREJ MATLAB code for artifactRej.fig
%      ARTIFACTREJ, by itself, creates a new ARTIFACTREJ or raises the existing
%      singleton*.
%
%      H = ARTIFACTREJ returns the handle to a new ARTIFACTREJ or the handle to
%      the existing singleton*.
%
%      ARTIFACTREJ('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ARTIFACTREJ.M with the given input arguments.
%
%      ARTIFACTREJ('Property','Value',...) creates a new ARTIFACTREJ or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before artifactRej_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to artifactRej_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help artifactRej

% Last Modified by GUIDE v2.5 20-Jun-2018 11:12:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @artifactRej_OpeningFcn, ...
                   'gui_OutputFcn',  @artifactRej_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before artifactRej is made visible.
function artifactRej_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to artifactRej (see VARARGIN)
...
% UIWAIT makes artifactRej wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = artifactRej_OutputFcn(hObject, eventdata, handles) 
