...
for i = z:numel(fFiles)
    ...
    if ~isempty(data.event)
        ...
        ECG.postAvgBPM = zeros(5); % Avg BPM for post across a fixed window
        ...
        ECG.postMedBPM_5 = zeros(5);    % Median Average BPM across entire period
        ...
        ECG.posthrVarData_15 = zeros(5); %heart rate variablity for post 15 second bins
